...
func TestSchedule(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			if got := booking.Schedule(tc.in); !got.Equal(tc.want) {
...
func TestHasPassed(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			if got := booking.HasPassed(tc.in); got != tc.want {
...
func TestIsAfternoonAppointment(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			if got := booking.IsAfternoonAppointment(tc.in); got != tc.want {
...
func TestDescription(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			if got := booking.Description(tc.in); got != tc.want {
...
func TestAnniversaryDate(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			if got := booking.AnniversaryDate(); !got.Equal(tc.want) {
